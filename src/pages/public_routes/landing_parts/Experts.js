    ...
    <div>
      <div className="max-w-2xl mx-auto text-center py-12 px-4 sm:py-20 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-extrabold text-black sm:text-4xl">
          <span className="block text-lg font-light mb-4">Professional Services</span>
        ...
        <a
          href="/contact/form"
          className="mt-8 w-full inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-black bg-white hover:bg-yellow-600 hover:text-white sm:w-auto"
        >
