import { features } from "../../../../../../Data/Restaurant_Landing_Featrues";

const Restaurant_Features = (props) => {
  return (
            ...
            {features.map((feature) => (
              <div key={feature.name} className="pt-6">
                <div className="flow-root rounded-lg bg-gray-50 px-6 pb-8">
                  <div className="-mt-6">
                    <div>
                      <span className="inline-flex items-center justify-center rounded-md bg-yellow-600 p-3 shadow-lg">
...
export default Restaurant_Features;