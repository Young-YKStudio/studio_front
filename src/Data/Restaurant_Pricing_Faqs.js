export const faqs = [
  {
    question: "Do you have any demo websites for each plans?",
    answer:
      "Demo webiste is under development.",
  },
  {
    question: "Who is the F&B Starter package built for?",
    answer:
      "F&B starter is biult for single-location restaurant or cafe owners, with between 1-5 employees, that want to take advantage of online ordering and delivery now through a digital storefront.",
  },
  {
    question: "I already have a website working. Can I keep my domain address?",
    answer:
      "Our development team will help you to keep your current domain address. You're responsible for keeping the domain alive, and also you will need to provide us DNS server address and ports to keep domain address. The deployment server will be changed.",
  },
  {
    question: "Are there any additional fees or costs?",
    answer:
      "Not like any other website providers, there is no setup fees, no onboarding fees, and your monthly rate does not change from us. There are maybe some charges required on online payment processing fee depends on what payment gateway is used.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "F&B Starter is built for small food and beverage business. It helps you to manage online orders, reservations, pick-up and devliery orders, and marketings. It will drastically improve your business while it stays in one fixed monthly cost.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "F&B package websites provide an online presence and attract, engage, transact, and re-market to their customers. For its owners, the package becomes a tool to manage online orders, reservation, pick-up orders, update menu, and marketings.",
  },
  {
