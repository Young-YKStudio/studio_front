      ...
      <Popover className="relative mx-8 my-2">
        {({ open }) => (
          <>
            ...
            >
              <Popover.Panel className="absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-[80vw] max-w-xs sm:px-0">
        ...
        {({ open }) => (
          <>
            ...
            <Transition
              ...
              leaveTo="opacity-0 translate-y-1"
            >
              <Popover.Panel className="absolute z-10 left-1/2 transform -translate-x-2/3 mt-3 px-2 w-[80vw] max-w-xs sm:px-0">
                <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                  <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
