...
const DemoFBS_Dash_Order_Ready = ({receivedOrders, modalHandler}) => {
  return (
    <>
      {
        receivedOrders.length > 0 ?
        <>
          <p className="text-3xl text-white border-b-2 border-double pb-2 my-6 font-bold truncate lg:text-center">Ready Orders :&nbsp;&nbsp;<span>{receivedOrders.length} </span></p>
...
export default DemoFBS_Dash_Order_Ready;