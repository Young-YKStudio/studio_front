    ...
    <>
      {
        ...
        <>
          <p className="text-3xl text-white border-b-2 border-double pb-2 mt-4 mb-6 font-bold truncate lg:text-center">New Orders :&nbsp;&nbsp;<span>{receivedOrders.length} </span></p>
